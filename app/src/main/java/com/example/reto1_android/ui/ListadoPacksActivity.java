...
import com.example.reto1_android.adapter.PackGestorAdapter;
...
public class ListadoPacksActivity extends AppCompatActivity {

    private List<PackBean> pack;
    private List<PackBean> packsFiltrados;
    private RecyclerView recycler;
    private PackGestorAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gestor_pack_listado);

        recycler = findViewById(R.id.rvPacks);
        getPacks();
    }
        ...
        if(isNetworkAvailable(this)){
            ...
            call.enqueue(new Callback<PacksBeans>() {
                ...
                public void onFailure(Call<PacksBeans> call, Throwable t) {
                    showErrorAlert(getString(R.string.error)+t.getMessage());
                }
            });
        }else{
    ...
    private void cargarRecycler(){
        ...
        adapter = new PackGestorAdapter(this, pack, this);
