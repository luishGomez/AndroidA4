...
public class ApunteBean implements Serializable {
    ...
    public ApunteBean(Integer idApunte, String titulo, String descripcion, byte[] archivo, Date fechaValidacion, int likeCont, int dislikeCont, float precio, ClienteBean creador, MateriaBean materia) {
